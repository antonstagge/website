          ...
          <div className="xs:w-full sm:w-3/5">
            ...
            <div className="pt-2 flex flex-col">
              ...
              <textarea
                ...
                onChange={(e) =>
                  this.handleInput(InputType.Message, e.target.value)
                }
              />
            </div>
            <Captcha
              setCaptchaValid={(valid) => {
                if (valid) {
                  this.setState({
                    canSend: this.state.canSend & ~CanSend.Captcha,
                  });
                } else {
                  this.setState({
                    canSend: this.state.canSend | CanSend.Captcha,
            ...
            <div className="flex justify-end">
              {this.state.sending ? (
                <div className="text-lg h-10 flex flex-col justify-center text-center font-semibold">
                  Sending...
                </div>
